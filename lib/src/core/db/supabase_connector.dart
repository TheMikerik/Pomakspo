...
List<RegExp> _fatalResponseCodes = [
  RegExp(r'^22...$'),
  RegExp(r'^23...$'),
  RegExp(r'^42501$'),
];
...
class SupabaseConnector extends PowerSyncBackendConnector {
  ...
  Future<PowerSyncCredentials?> fetchCredentials() async {
    ...
    if (getFlavor() == Flavor.prod) {
      ...
      // LOCAL DEV
      return PowerSyncCredentials(
        endpoint: Platform.isAndroid
            ? Env.powersyncAndroidLocalUrl
            : Env.powersyncIOSLocalUrl,
        token: token,
        userId: userId,
        expiresAt: expiresAt,
      );
  ...
  Future<void> uploadData(PowerSyncDatabase database) async {
    ...
    try {
      ...
      if (e.code != null &&
        ...
        /// records elsewhere instead of discarding, and/or notify the user.

        // errorLogger.logError(e, null);
