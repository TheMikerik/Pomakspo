...
import 'package:pomakspo/src/core/common/providers/connection_checker_provider.dart';
import 'package:pomakspo/src/core/error/app_exception.dart';
import 'package:pomakspo/src/features/auth/domain/app_user.dart';
...
class AuthRepositoryImpl implements AuthRepository {
    ...
    try {
      ...
      if (Platform.isIOS) {
        ...
        await _client.auth.signInWithOAuth(
          OAuthProvider.apple,
          // TODO(standa): android redirect deeplink
  ...
  Future<void> signOut() async {
    ...
    await Future.wait([
      ...
      // TODO: uncomment this when PowerSync is ready
